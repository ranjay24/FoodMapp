...
const Restaurant = () => {
  ...
  return (
<div className="font-serif max-w-6xl mx-auto my-10 p-8 rounded-xl shadow-xl bg-gradient-to-r from-gray-800 to-black ">
  <h1 className="text-white font-extrabold text-3xl text-gray-800 mb-8 text-center">
