...
const ForgotPassword = () => {
  ...
  return (
    <div
    className="font-serif flex items-center justify-center min-h-screen w-full animate-fade-in-up"
    style={{
  ...
  >
    <form
      className="flex flex-col gap-5 md:p-8 w-full max-w-md rounded-lg border-2 border-gray-400 bg-white bg-opacity-90 shadow-lg mx-4 animate-fade-in-up"
    >
