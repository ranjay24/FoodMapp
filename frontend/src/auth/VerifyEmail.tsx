...
const VerifyEmail = () => {
  ...
  return (
    <div
    className="flex items-center justify-center h-screen w-full animate-fade-in-up"
  >
    <div className="p-8 rounded-md w-full max-w-md flex flex-col gap-10 border border-gray-200 animate-fade-in-up">
