...
<div className="font-serif flex flex-col md:flex-row max-w-7xl mx-auto md:p-10 rounded-lg items-center justify-center m-4 gap-20 relative bg-cover bg-center" style={{ backgroundImage: `url(${Background1})` }}>
  <div className="absolute inset-0 bg-gray-800 opacity-90 pointer-events-none"></div>
    ...
    <form
      ...
      className="font-serif max-w-4xl mx-auto my-10 p-6 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 shadow-md rounded-lg relative z-10"
    >
      {/* Profile Header */}
      <div className="flex items-center justify-between mb-6 animate-fade-in-up">
        <div className="flex items-center gap-4">
          ...
          <Input
            ...
            className="text-2xl font-semibold border-b-2 border-gray-300 focus:border-orange focus:outline-none animate-fade-in-up"
          />
        </div>
      </div>
      ...
      <div className="text-center mt-8 animate-fade-in-up">
        {isLoading ? (
          ...
          <Button
            type="submit"
            className="px-6 py-2 bg-gray-800 hover:bg-gray-700 text-white font-semibold rounded-md"
          >
            Update Profile
          </Button>
        )}
