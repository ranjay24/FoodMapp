...
const FilterPage = () => {
  ...
  return (
    <div className="font-serif md:w-80 bg-gradient-to-b from-orange-100 to-orange-300 shadow-lg rounded-lg p-6 border border-gray-300 space-y-4 animate-fade-in-left">
    {/* Header */}
    ...
    <div className="divide-y divide-gray-200">
      {filterOptions.map((option) => (
        <div
          key={option.id}
          className="flex items-center space-x-3 py-3 hover:bg-gray-50 rounded-md px-2 transition duration-300 animate-fade-in-up"
        >
          {/* Checkbox */}
          <Checkbox
            id={option.id}
